...
// urls 
exports.loginUsersAddress = "http://localhost:8000/api/loginUsers";
exports.usersAddress = "http://localhost:8000/api/users";
exports.permissionsAddress = "http://localhost:8000/api/permissions";
exports.membersAddress = "http://localhost:8000/api/members";
exports.moviesAddress = "http://localhost:8000/api/movies";
exports.subscriptionsAddress = "http://localhost:8000/api/subscriptions";
