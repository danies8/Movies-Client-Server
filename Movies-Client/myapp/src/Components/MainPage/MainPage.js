...
function MainPage(props) {
    ...
    const { isUserAdmin, hasPermissionForSubscriptions, hasPermissionForMovies, loginUserName, accessToken } = useContext(AppContext);
     ...
     return (
        <div >
            <Typography className={classes.root}>
                ...
                <NavLink to={common.login} onClick={zeroAccessToken}>
