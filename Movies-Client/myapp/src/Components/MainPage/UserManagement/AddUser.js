...
function AddUser(props) {
    ...
    const validate = async values => {
        ...
        else if (await (await userUtils.isUserNameExists(values.userName, stateAccessToken))) {
    ...
    const formik = useFormik({
        ...
        onSubmit: async values => {
            ...
            const results = await userUtils.addUser(addUser, addPermissions, loginUser, stateAccessToken);
