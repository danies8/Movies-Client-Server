...
function LogInPage(props) {
  ...
  const [errorMessage, setErrorMessage] = useState("");
   ...
   const { userId, isUserAdmin,
    ...
    loginUserName, accessToken } = useContext(AppContext);
  ...
  const createAccount = () => {
    props.history.push(common.createAccount);
  }
        ...
        <Container maxWidth="md">
          ...
          <form onSubmit={formik.handleSubmit}>
            ...
            <Button type="submit" variant="contained" color="primary" >Login</Button><br />
               New User?:<Button variant="outlined" color="primary" onClick={createAccount} size="small" className={classes.margin}>
              Create Account
             </Button><br />
             {errorMessage}
          </form>
